                        ...
                        this.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent arg0) {
                                ...
                                if (Integer.parseInt(txtHP.getText()) > 31)
                                    txtHP.setText("31");
                                for (int i = 0; i < 3; i++) {
                                    if (Integer.parseInt(txtAtk[i].getText()) > 31)
                                        txtAtk[i].setText("31");
                                    if (Integer.parseInt(txtDef[i].getText()) > 31)
                                        txtDef[i].setText("31");
                                    if (Integer.parseInt(txtSpa[i].getText()) > 31)
                                        txtSpa[i].setText("31");
                                    if (Integer.parseInt(txtSpd[i].getText()) > 31)
                                        txtSpd[i].setText("31");
                                    if (Integer.parseInt(txtSpe[i].getText()) > 31)
                                        txtSpe[i].setText("31");
                                }
                                ...
                                c.search(Integer.parseInt(txtMinFrame.getText()),
                                    Integer.parseInt(txtMaxFrame.getText()), Integer.parseInt(txtID.getText()),
                                    ((PokemonData) cmbPokemon.getSelectedItem()).getID(),
                                    new StatPack(Integer.parseInt(txtHP.getText()),
                                        Integer.parseInt(txtAtk[0].getText()), Integer.parseInt(txtDef[0].getText()),
                                        Integer.parseInt(txtSpa[0].getText()), Integer.parseInt(txtSpd[0].getText()),
                                        Integer.parseInt(txtSpe[0].getText())),
                                    new StatPack(Integer.parseInt(txtHP.getText()),
                                        Integer.parseInt(txtAtk[1].getText()), Integer.parseInt(txtDef[1].getText()),
                                        Integer.parseInt(txtSpa[1].getText()), Integer.parseInt(txtSpd[1].getText()),
                                        Integer.parseInt(txtSpe[1].getText())),
                                    new StatPack(Integer.parseInt(txtHP.getText()),
                                        Integer.parseInt(txtAtk[2].getText()), Integer.parseInt(txtDef[2].getText()),
                                        Integer.parseInt(txtSpa[2].getText()), Integer.parseInt(txtSpd[2].getText()),
