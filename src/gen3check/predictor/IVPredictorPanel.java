    ...
    public IVPredictorPanel(final IVPredictorWindow ivpw) {
        ...
        this.table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent arg0) {
                ...
                Pokemon p = new Pokemon(IVPredictorPanel.this.pokemonID, 5,
                    new StatPack(pkmRNG.hp, pkmRNG.atk, pkmRNG.def, pkmRNG.spa, pkmRNG.spd, pkmRNG.spe),
                    new StatPack(0), pkmRNG.nature, new Ability(0), new PokemonItem(0), false);
