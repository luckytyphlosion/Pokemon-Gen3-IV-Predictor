...
public class PokemonData extends Data {
    public PokemonData(int n) {
        ...
        this.baseStat = new StatPack(Integer.parseInt(data[1]), Integer.parseInt(data[2]), Integer.parseInt(data[3]),
        ...
        this.EV = new StatPack(Integer.parseInt(data[2]), Integer.parseInt(data[3]), Integer.parseInt(data[4]),
     ...
     * @param n
     */
    private PokemonData(int n, String name, StatPack baseStat, int exp, StatPack EV, PokemonType type1,
        PokemonType type2, ExperienceType expType) {
        super(n, name);
    ...
    public PokemonData getCopy() {
        return new PokemonData(n, this.getName(), this.baseStat.getCopy(), this.exp, this.EV.getCopy(),
            this.type1.getCopy(), this.type2.getCopy(), this.expType.getCopy());
    }
