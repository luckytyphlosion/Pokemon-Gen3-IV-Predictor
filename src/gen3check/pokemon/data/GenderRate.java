...
public enum GenderRate {
    ...
    public static GenderRate fromInt(int n) {
        switch (n) {
        case 0:
            return GenderRate.MaleOnly;
        case 1:
            return GenderRate.Male87;
        case 2:
            return GenderRate.Male75;
        case 3:
            return GenderRate.Male50;
        case 4:
            return GenderRate.Male25;
        case 5:
            return GenderRate.FemaleOnly;
        case 6:
