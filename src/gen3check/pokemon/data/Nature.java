...
public class Nature extends Data {
    ...
    public void setNature(int n) {
        ...
        for (int i = 0; i < StatPack.STAT_N; i++)
            natureBoost[i] = 1;
        if (n % StatPack.STAT_N == 0)
            return; // neutral natures
    ...
    /**
     * get Nature Order for nature boost atk,def,spa,spd,spe to atk,def,spe,spa,spd
     * 
     * @param n
     * @return
     */
    ...
    private final static String[] toStr = { "Hardy", "Lonely", "Brave", "Adamant", "Naughty", "Bold", "Docile",
