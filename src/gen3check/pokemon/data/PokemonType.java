...
public class PokemonType extends Data {
    ...
    private final static String[] toStr = { "Fighting", "Flying", "Poison", "Ground", "Rock", "Bug", "Ghost", "Steel",
        "Fire", "Water", "Grass", "Electric", "Psychic", "Ice", "Dragon", "Dark", "Normal", "None", "Unknown" };
    ...
    public static List<PokemonType> getList() {
        ...
        for (int i = 0; i < POKEMONTYPE_N; i++) { // < instead of <= cause there's no "none" type at the beginning. List
