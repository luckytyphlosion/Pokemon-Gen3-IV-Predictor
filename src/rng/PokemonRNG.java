...
public class PokemonRNG {
    ...
    protected void generate(RNG rng) {
        ...
        if (genderAux < 31)
            this.minGender = 12;
        else if (genderAux < 64)
            this.minGender = 25;
        else if (genderAux < 127)
            this.minGender = 50;
        else if (genderAux < 191)
            this.minGender = 75;
        else
            this.minGender = 100;
    }
    ...
    public boolean isFemale(GenderRate gr) {
        ...
        case Genderless:
            return false;
        case Male25:
            return this.minGender <= 75;
        case Male50:
            return this.minGender <= 50;
        case Male75:
            return this.minGender <= 25;
        case Male87:
            return this.minGender <= 12;
        case MaleOnly:
            return false;
        default:
            return false;
